 ...
 * 
 */
export class GLTUnsafeRegister<Element extends GLTIdentifiable> implements GLTRegister<Element> {
  /**
   * 
   */
  ...
  /**
   * Allocate a new empty GLTUnsafeRegister with the requested capacity.
   * 
  ...
  public equals(other: any): boolean {
    ...
    if (other instanceof GLTUnsafeRegister) {
 ...
 * 
 */
export namespace GLTUnsafeRegister {
  /**
   * 
   */
  export function create<Element extends GLTIdentifiable>(capacity: number = 32): GLTUnsafeRegister<Element> {
    return new GLTUnsafeRegister(capacity)
  }
}